...
- env: `AI_ORG_OS_MIND_LOOP_CYCLE_TIMEOUT` (default `300` 秒、C category で上書き可)
...
|---|---|---|---|---|
| #134: cycle 2 が 640s / 655s (gm / carol) | F1 (振る舞い系、観察量爆発) | A 追加 | per-cycle timeout (§2.1) | **未実装、本 ADR で枠を確定** |
