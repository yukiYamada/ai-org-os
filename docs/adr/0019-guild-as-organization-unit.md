...
└── members.md       # 現所属 Mind のリスト（動的、Mind spawn/kill で更新）
```
...
- `.mind-meta.md` に `guild:` フィールド追加
- spawn 時に Guild manifest を確認し、`kind` が members に含まれることを検証
