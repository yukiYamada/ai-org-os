...
#### bash-editor（`C:\Users\kokoro068\git\local-multi-window-bash-editor`）
...
#### claude-team（`C:\Users\kokoro068\git\claude-team`）
...
| リポジトリ | パス | スナップショット |
|---|---|---|
| local-multi-window-bash-editor | `C:\Users\kokoro068\git\local-multi-window-bash-editor` | （Accepted 時に commit hash を記入） |
| claude-team | `C:\Users\kokoro068\git\claude-team` | （Accepted 時に commit hash を記入） |
