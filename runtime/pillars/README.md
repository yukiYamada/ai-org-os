...
- `$AI_ORG_OS_HOME/minds/<name>/` — 各 Mind の Mindspace（不可侵領域、所有者 Mind のみ、ADR-0018）
- `$AI_ORG_OS_HOME/{kinds,personas,guilds}/` — 利用者が定義する組織依存物 (ADR-0020)
- `templates/{kinds,personas,guilds}/` — ai-org-os 同梱のテンプレ。本体に投げる PR で更新 (ADR-0020)
